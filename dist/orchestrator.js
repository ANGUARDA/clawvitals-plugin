...
import { CONTROL_LIB_VERSION, WORKSPACE_DIR, LOCK_FILE, } from './constants';
/**
...
export class ScanOrchestrator {
    ...
    scheduler;
    workspaceDir;
    constructor(collector, evaluator, scorer, delta, reporter, storage, config, telemetry, scheduler, workspaceDir) {
    ...
    async run(options) {
        ...
        return withFileLock(lockPath, {
            ...
            const success = collected.security_audit.ok &&
                collected.health.ok &&
                collected.update_status.ok;
            // Assemble run report
            const report = {
                version: CONTROL_LIB_VERSION,
