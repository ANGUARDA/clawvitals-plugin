...
function errorResult(reason, defaults) {
...
export class ExpandedCollectorOrchestrator {
    async collect(options) {
        const [ollamaResult, networkResult, secretsFilesResult, secretsHistoryResult, cloudflareTunnelResult, dockerResult, osUpdatesResult, diskEncryptionResult,] = await Promise.allSettled([
