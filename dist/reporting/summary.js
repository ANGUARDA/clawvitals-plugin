 ...
 */
export function formatSummary(report, delta, staleExclusions) {
    ...
    const critHighCount = stable.findings.filter(f => f.result === 'FAIL' && (f.severity === 'critical' || f.severity === 'high')).length;
    // Delta indicator
    let deltaLine;
