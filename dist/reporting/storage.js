...
import { WORKSPACE_DIR, RUNS_DIR, LAST_SUCCESS_FILE, SECURE_FILE_MODE, } from '../constants';
/**
...
export class StorageManager {
    ...
    writeRun(report, detailText) {
        ...
        if (report.meta.success) {
            ...
            const pointer = { run_dir: report.meta.scan_ts };
    ...
    loadLastRun() {
        try {
            ...
            if (typeof pointer.run_dir !== 'string' || !pointer.run_dir)
                return null;
